...
<main>
  <section style="background-image: url('img/page/outsource/hero/background.svg');" id="hero" class="section section--primary">
    <div class="container">
      <div class="hero">
        <div class="hero__content">
          ...
          <h2 class="hero__subtitle section__subtitle page__subtitle">
            Требуется персонал для сезонной или
            <br>
            временной работы? Мы поможем сократить
            <br>
            себестоимость по аренде помещения и
            <br>
  ...
  <section data-name="Подробнее" id="explain" class="section">
    <div class="container">
      <div class="section__header text-center">
        <h2 class="section__title section__title--underline">Что такое аутсорсинг</h2>
      </div>
      <!-- /.section__header -->
          ...
          <div class="col-6">
            <div class="textblock__content">
              <ul class="textblock__list list list--big">
                <li class="list__item">
                  Штатный сотрудник ничем не замотивирован выполнять свою работу - он может просиживать рабочее время. Сотрудникам на аутсорсинге платят исключительно за результат
                </li>

                <li class="list__item">
                  Вы сохраняете юридический статус компании. Если не нанимать сотрудников в штат, а заменять их подрядчиками
                  на аутсорсинге, ваша фирма будет удовлетворять требованиям малого предприятия, даже при фактической работе большого количества сотрудников
                </li>

                <li class="list__item">
                  В компаниях выставляющих свои акции на бирже наличие большого количества непрофильных подразделений, не приносящих прибыли плохо отражается на общей отчетности
                </li>
              </ul>
            </div>
            <!-- /.textblock__content -->
        ...
        <div class="row align-items-center">
          ...
          <div class="col-6 offset-1">
            <div class="textblock__content">
              ...
              <p class="textblock__paragraph">
                Ответьте на пару вопросов и определите примерную стоимость найма персонала
                в вашу фирму
              </p>
